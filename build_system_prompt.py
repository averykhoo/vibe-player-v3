...
INCLUDED_EXTENSIONS = {
    ...
    "ex", "exs", "erl", "hrl", "f", "feature", "for", "f90", "f95", "txt", "text", "log",
    "go", "gql", "graphql", "groovy", "hs", "html", "htm", "ini", "java",
    "js", "mjs", "cjs", "json", "jsonl", "jsp", "jsx", "jl", "kt", "kts",
    "tex", "less", "lua", "mk", "makefile", "md", "markdown", "m", "mm", "mermaid",
...
def get_file_type_and_hint_by_extension(filepath: Path) -> Tuple[Optional[str], bool]:
    ...
    if not suffix or suffix == '.':
        ...
        if no_ext_name in {"makefile", "dockerfile", "readme", "license", 'vibe-player-v3'} or \
