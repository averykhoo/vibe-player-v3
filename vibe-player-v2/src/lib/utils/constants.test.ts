...
describe('Constants', () => {
    it('AUDIO_ENGINE_CONSTANTS should be defined and have expected properties', () => {
        ...
        expect(AllConstants.AUDIO_ENGINE_CONSTANTS.PROCESSOR_NAME).toBe('rubberband-processor');
        expect(AllConstants.AUDIO_ENGINE_CONSTANTS.WASM_BINARY_URL).toBe('/rubberband.wasm');
    });
    ...
    it('VISUALIZER_CONSTANTS should be defined and have expected properties', () => {
        ...
        expect(AllConstants.VISUALIZER_CONSTANTS.WAVEFORM_COLOR_DEFAULT).toBe('#26828E');
