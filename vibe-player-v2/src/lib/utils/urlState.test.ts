...
describe('urlState utilities', () => {
    ...
    describe('loadStateFromUrl', () => {
        it('should call playerStore.update with parsed speed from URL', () => {
            ...
            const lastCallArg = (playerStore.update as ReturnType<typeof vi.fn>).mock.calls[0][0];
        ...
        it('should call analysisStore.update with parsed VAD thresholds from URL', () => {
            ...
            const lastCallArg = (analysisStore.update as ReturnType<typeof vi.fn>).mock.calls[0][0];
    ...
    describe('subscribeToStoresForUrlUpdate', () => {
        ...
        it('debounced URL updater should call goto eventually after store change (if initialized)', () => {
            ...
            (playerStore.subscribe as ReturnType<typeof vi.fn>).mockImplementation((cb) => {
            ...
            expect((goto as ReturnType<typeof vi.fn>).mock.calls[0][0]).toContain(`${URL_HASH_KEYS.SPEED}=1.5`);
        });
        ...
        it('should return an unsubscribe function that calls store unsubscribers', () => {
            ...
            (playerStore.subscribe as ReturnType<typeof vi.fn>).mockReturnValue(mockPlayerUnsub);
            (analysisStore.subscribe as ReturnType<typeof vi.fn>).mockReturnValue(mockAnalysisUnsub);
